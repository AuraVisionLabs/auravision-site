...
For an example of what this looks like in practice, see how [Virgin Media O2 rolled out full-store analytics across all 307 UK stores](/case-studies/virgin-media-o2-x-aura-vision-full-scale-roll-out) — achieving a 22X return on investment by using in-store data to optimise display engagement and staffing decisions at scale.
