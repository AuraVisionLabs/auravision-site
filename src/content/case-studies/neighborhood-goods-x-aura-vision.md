...
metrics:
  - value: "30%"
    label: "More accurate conversion rate & customer counts"
  - value: "45%"
    label: "Better store utilisation of areas & departments"
---
...
- **Compare data between zones and locations** — the ability to compare data between different in-store zones and store locations
- **Customer engagement data per product zone** — data collection of customer engagement per product zones for external reporting
...
First, to improve their customer lifetime value, they started reporting weekly traffic and product impressions. Neighborhood Goods became a data platform for their brand partners. By communicating to them insight beyond conversion, their clients were able to review their sales funnel, identify recurring trends and conversion drivers.
...
- **Window display engagement** — Customer engagement at entrance
- **Store utilisation** — of areas and departments
- **Store design iteration** — Plan, test and iterate store designs
- **New product launches** — New product launch impacts
...
- **Comprehensive reporting** — Sales performance reporting
