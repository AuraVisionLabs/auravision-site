...
metrics:
  ...
  - value: "34%"
    label: "Improvement in staff-customer allocation"
  - value: "4.5X"
    label: "ROI"
---
...
- **Improving the customer experience** — Enhancing the in-store journey for shoppers
- **Driving conversion rates** — Turning footfall into sales
- **Increasing productivity** — Making staff operations more efficient
- **A more accurate view of Footfall** — Better visibility of in-store operations
...
The Flannels team also made use of several other Aura Vision products:

- **Enhanced Footfall** — Provides a simple view of store performance, including passer-by traffic, footfall, conversion and customer demographics
- **Path to Purchase** — Captures product engagement and demographic segmentation insights used to optimise departmental performance, and align retail stores with the overall direction of the business
- **Basket Recovery** — Evidences the impacts of the new staffing allocations during busy peak periods and reduces basket abandonment rates by measuring queue times and checkout times
